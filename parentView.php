<?php
    ...
    include_once("Controller/ParentControllor.php");
   
 $parent= new parentControllor();
...
<section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="parentView.php">Add new parent</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Fill in the form to add a new parent</h3>
