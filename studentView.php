<?php
    ...
    include_once("Controller/StudentControllor.php");
   
 $student= new studentControllor();
...
<section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="studentView.php">Add new student</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Fill in the form to add a new student</h3>
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="">
                  ...
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Parent Name</label>
                    <div class="col-lg-10">
