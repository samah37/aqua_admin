<?php
    ...
    include_once("Controller/contactControllor.php");
   
 $contact= new contactControllor();
...
<section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Contact program</h3>
        <div class="row">
          <div class="col-md-12">
                  ...
                  <?php
                        ...
                        $database = "admin_aqua";  
                          $message = "";  
                               ...
                               $stmnt=$conn->prepare("SELECT * FROM contacts ");
                              $stmnt->execute();
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Fill in the form to update a contact</h3>
              ...
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="">
                  ...
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Contact</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="day" name="contact" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2"> Content</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="starter" name="content" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">link</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="main" name="link" type="text" />
                    </div>
                  </div>
