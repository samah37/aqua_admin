...
<section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="presentationView.php">Add paragraph</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Fill in the form to add a new paragraph</h3>
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="">
                  ...
                  <div class="form-group ">
                    <label for="ccomment" class="control-label col-lg-2">Your text</label>
                    <div class="col-lg-10">
